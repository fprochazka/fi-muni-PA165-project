    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http
            .authorizeRequests()
                ...
                .antMatchers("/team/{teamId}/player/create").hasAnyRole("ADMIN", "MODERATOR")
                .antMatchers("/team/{teamId}/player/{playerId}/edit").hasAnyRole("ADMIN", "MODERATOR")
                .antMatchers("/team/{teamId}/player/{playerId}/delete").hasAnyRole("ADMIN", "MODERATOR")

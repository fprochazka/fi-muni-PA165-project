        ...
        <div class="container">
             <div class="row">
                 <div class="col-md-8 offset-md-2">
                     ...
                     <form:form class="form-horizontal match-form" method="post" modelAttribute="matchRequest" action="${requestScope['javax.servlet.forward.request_uri']}" autocomplete="off">
                         <fieldset>

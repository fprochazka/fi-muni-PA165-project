        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a href="<c:url value="/teamPlayer/${team.id}/results"/>" class="nav-link">Top Scorers</a>
                    </li>
                    <li class="nav-item">
                        <a href="<c:url value="/teamPlayer/${team.id}/schedule"/>" class="active nav-link">Top Assistants</a>
                    </li>
                </ul>
                <!-- Content centered -->
